...
const Navbar = () => {
  return (
    <div className="w-full fixed py-10 flex items-center justify-center z-[999]">
      <div className="w-[30vw] bg-white rounded-full px-2 py-2 flex items-center justify-between ring ring-primary gap-2">
        <Link href="/">
          <Image src="/Logo.png" width={50} height={50} alt="Logo" className="pl-3  " />
        </Link>
